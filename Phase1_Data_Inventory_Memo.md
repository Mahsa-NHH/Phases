...
Emission data completeness improves with vehicle vintage (Figs. 17–20): both CO₂ and NOₓ values begin to appear in the late 1990s and become systematic through the 2000s, consistent with the implementation of Euro 3 and subsequent EU type-approval reporting requirements. Missingness diagnostics (Fig. 16) confirm that vehicles lacking emission data are primarily older gasoline models and smaller vehicles, reflecting early data gaps rather than selective reporting.
